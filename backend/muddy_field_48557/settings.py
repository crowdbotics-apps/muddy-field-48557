"""
Django settings for muddy_field_48557 project.
...
ROOT_URLCONF = 'muddy_field_48557.urls'
...
WSGI_APPLICATION = 'muddy_field_48557.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Muddy Field Support <support@muddy-field-48557.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "muddy_field_48557 API",
    "DESCRIPTION": "API documentation for muddy_field_48557 App",
    "VERSION": "v1",
}
